...
export type CustomerCustomerId = number & { __brand: 'public.customer' };

/** Represents the table public.customer */
export default interface CustomerTable {
  customer_id: ColumnType<CustomerCustomerId, CustomerCustomerId | undefined, CustomerCustomerId>;
