...
import { convertV3ConfigToV4, createV3CompatibilityData } from "./config-conversion";
import type { KanelContext } from "./context";
...
describe("V3 to V4 Config Conversion", () => {
  ...
  describe("createV3CompatibilityData", () => {
    it("should extract wrapped metadata functions", () => {
      ...
      const compatData = createV3CompatibilityData(v3Config, baseInstantiatedConfig);
